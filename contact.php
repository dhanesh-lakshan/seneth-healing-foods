...
<html lang="en">
  <head>
    ...
    <title>Seneth Healing Foods - Contacts</title>
  ...
  <body class="index-page">
    ...
    <section id="contact" class="contact section">
      ...
      <div class="container">
        <div class="mb-5">
          <iframe class="rounded" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3959.332410908115!2d79.99443267568195!3d7.087410216352111!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3ae2fbf209fa7cf3%3A0xcf9ce347ca8e630a!2sJayantha%20Road%2C%20Gampaha!5e0!3m2!1sen!2slk!4v1726075259157!5m2!1sen!2slk" width="100%" height="400px" style="border:0; " allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
        </div>
        <!-- End Google Maps -->
        ...
        <div class="row gy-4">
          ...
          <div class="col-md-6">
            <div class="info-item d-flex align-items-center">
              ...
              <div>
                <h3>Call Us</h3>
                <p><i class="bi bi-telephone"></i> &nbsp; +94 77 724 5308</p>
                <p><i class="bi bi-whatsapp "></i> &nbsp; +94 71 230 1848 </p>
              </div>
            </div>
          </div>
          <!-- End Info Item -->
          ...
          <div class="col-md-6">
            <div class="info-item d-flex align-items-center">
              ...
              <div>
                <h3>Email Us</h3>
                <p>sunandhaweerasinghe@gmail.com</p>
                <p>senethexports@gmail.com</p>
              </div>
            </div>
          </div>
          <!-- End Info Item -->
        ...
        <form
          action="project/Adddatabase.php"  method="post"  class="php-email-form"  id="phone-form">
          <div class="row gy-4">
            <!-- First Name -->
            <div class="col-md-6">
            ...
            <!-- Country Select -->
            <div class="col-md-6">
              <select name="country"  type="text"  class="form-control country-select"  required>
            ...
            <div class="col-md-6">
              <div class="input-group col-12 col-sm-6">
                  <select  class="form-control country-code-select"  name="countryCode"  id="countryCode"  required>
            ...
            <div class="col-12 col-sm-6">
              <input  type="tel"  class="form-control col-12 col-sm-6"  name="phoneNumber"  id="phoneNumber"  placeholder="Your Phone Number"  required/>
            </div>
            ...
            <!-- Enquiry -->
            <div class="col-md-12">
              <textarea  class="form-control"  name="enquiry"  rows="6"  placeholder="Enquiry"  required="" ></textarea>
            </div>
