...
if (isset($_GET['id']) && isset($_GET['category'])) {
    ...
    if ($category === 'veganplant') {
        ...
        $sql = "
            SELECT 
                ...
                fd.tags 
            FROM 
                vegan_plant_details  fd
            JOIN 
                vegan_plant f ON fd.id = f.id
            WHERE 
                fd.id = ?
        ";
    ...
    $detailSql = "SELECT detail1, detail2, detail3 FROM vegan_plant_description WHERE
    id = ?"; if ($detailStmt = $conn->prepare($detailSql)) {
              ...
              <div class="col-md-12">
                <div class="input-group">
                  <select
                    ...
                    required
                  >
                    <option value="" disabled selected>Country Code<i class="bi bi-arrow-down"></i></option>
