...
if (isset($_GET['id']) && isset($_GET['category'])) {
    ...
    if ($category === 'veganaccompaniments') {
        ...
        $sql = "
            SELECT 
                ...
                fd.tags 
            FROM 
                vegan_accompaniments_details fd
            JOIN 
                vegan_accompaniments f ON fd.id = f.id
            WHERE 
                fd.id = ?
        ";
    ...
    $detailSql = "SELECT detail1, detail2, detail3 FROM vegan_accompaniments_description
