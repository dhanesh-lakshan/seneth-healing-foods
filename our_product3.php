...
<head>
    ...
    <style>
        ...
        .item-torn {
            ...
            bottom: -2px;
            padding: 10px 0; 
            background-color: #5bc2e7; /* Turquoise background */
            clip-path: polygon(
...
<body class="index-page">
    ...
    <section id="products" class="products section" style="background-image: url(assets/image/back1.jpeg);">
        <div class="container section-title section-title-our-product">
            ...
            <p><span>Vegan</span> <span class="description-title">Egg Substitutes</span></p>
        </div>
        ...
        <div class="container">
            <div class="row d-flex">
                ...
                $sql = "SELECT id, name, image,description FROM vegan_egg";
                $result = $conn->query($sql);

                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        echo "<div class='main-card col-sm-12 col-md-6 col-lg-4 col-xl-3 mb-5 d-flex'>";
                        echo "<a href='our_product_description3.php?id=" . $row['id'] . "&category=veganegg'>";
